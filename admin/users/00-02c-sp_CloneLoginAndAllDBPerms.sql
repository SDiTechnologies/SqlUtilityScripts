...
BEGIN
  ...
  EXEC @Return = tempdb.dbo.CloneLogin 
    @NewLogin = @NewLogin, 
  ...
  BEGIN
    EXEC @Return = tempdb.dbo.CreateUserInDB 
	  @NewLogin = @NewLogin, 
	  @LoginToClone = @LoginToClone, 
	  @DBName = @DBName;
	...
	EXEC @Return = tempdb.dbo.GrantUserRoleMembership
	  @NewLogin = @NewLogin, 
	  @LoginToClone = @LoginToClone, 
	  @DBName = @DBName;
	...
	EXEC @Return = tempdb.dbo.CloneDBPerms
	  @NewLogin = @NewLogin, 
	  @LoginToClone = @LoginToClone, 
	  @DBName = @DBName;
